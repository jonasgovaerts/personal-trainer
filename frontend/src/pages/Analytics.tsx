    ...
    <Layout>
      <div className="space-y-8 max-w-6xl mx-auto pb-12">
        <div className="flex items-end justify-between">
          <div>
            <h1 className="text-3xl font-bold tracking-tight text-white">{t('nav.progress')}</h1>
            <p className="text-slate-400 mt-1">Deep dive into your performance and physical gains.</p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-slate-900 border border-slate-800 p-6 rounded-2xl">
            ...
            <div className="mt-4 flex items-center gap-1.5">
              ...
              <span className="text-xs text-slate-500 ml-1">vs last session</span>
            </div>
          </div>
          ...
          <div className="bg-slate-900 border border-slate-800 p-6 rounded-2xl">
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="text-sm font-bold text-slate-400 uppercase tracking-wider">Avg. Session</span>
            </div>
            <div className="flex items-baseline gap-2">
              <span className="text-3xl font-bold text-white">{avgVolumePerSession.toLocaleString()}</span>
              <span className="text-sm text-slate-500 font-medium">kg</span>
            </div>
            <p className="mt-4 text-xs text-slate-500">Calculated over {history.length} sessions</p>
          </div>
          ...
          <div className="bg-slate-900 border border-slate-800 p-6 rounded-2xl">
            ...
            <div className="flex items-baseline gap-2">
              <span className="text-3xl font-bold text-white">{user?.current_weight || '--'}</span>
              <span className="text-sm text-slate-500 font-medium">kg</span>
            </div>
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="bg-slate-900 border border-slate-800 p-6 rounded-2xl shadow-sm">
              <div className="flex items-center justify-between mb-6">
                <h3 className="font-semibold text-lg text-white">Lifting Volume Trend</h3>
            ...
            {/* Distribution */}
            <div className="bg-slate-900 border border-slate-800 p-6 rounded-2xl shadow-sm">
              <h3 className="font-semibold text-lg text-white mb-6">Exercise Frequency</h3>
          ...
          <div className="space-y-6">
            <div className="bg-slate-900 border border-slate-800 p-6 rounded-2xl shadow-sm">
              ...
              <div className="space-y-4">
                {personalBests.length === 0 ? (
                  <p className="text-sm text-slate-500 italic">Log workouts to see your PRs!</p>
                ) : (
                  personalBests.map((pr, idx) => (
                    <div key={idx} className="group p-4 bg-slate-950 border border-slate-800 rounded-xl hover:border-blue-500/50 transition-colors">
                      <p className="text-xs font-bold text-slate-500 uppercase tracking-widest mb-1">{pr.name}</p>
                      <div className="flex items-end justify-between">
                        <span className="text-xl font-bold text-white">{pr.weight} <span className="text-sm font-medium text-slate-400">kg</span></span>
            ...
            <div className="bg-gradient-to-br from-blue-600 to-blue-700 p-6 rounded-2xl shadow-lg text-white">
              ...
              <p className="text-blue-100 text-sm leading-relaxed mb-4">
                You've increased your total volume by 12% compared to last week. Your most improved exercise is <strong>Bulgarian Split Squats</strong>.
              </p>
              <div className="bg-white/10 backdrop-blur-sm p-3 rounded-xl">
                <p className="text-[10px] uppercase font-bold text-blue-200 mb-1">Upcoming Milestone</p>
                <div className="flex justify-between items-center">
                  <span className="text-sm font-bold">1,000kg Total Lifted</span>
                  <span className="text-xs">850/1000</span>
                </div>
              </div>
            </div>
          </div>
